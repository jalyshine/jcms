...
<div class="layui-card">
	<div class="layui-card-header">
        <span class="card-title">通告</span>
		<c:import url="../menubar.jsp?module=announce" />
	</div>
	<div class="layui-card-body">
		<form action="${ base }announce/Announce/list" method="get" class="layui-form" id="searchForm">
		...
		<table lay-filter="items" lay-even class="layui-table" lay-size="sm">
			...
			<c:forEach items="${ page.list }" var="announce">
				<tr>
					...
					<td>${ announce.hits }</td>
					<td>
						<fmt:formatDate value="${ announce.updateTime }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</td>
					<td>
						<a href="${ base }announce/Announce/edit?id=${ announce.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }announce/Announce/delete?id=${ announce.id }" name="delete"
