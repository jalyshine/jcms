...
<body>
<c:if test="${ picture.id == null }">
    <c:set value="${ base }content/Picture/add" var="save"/>
</c:if>
<c:if test="${ picture.id != null }">
    <c:set value="${ base }content/Picture/edit" var="save"/>
</c:if>

<div class="layui-card">
    <div class="layui-card-header">
        <span class="card-title">添加 & 编辑图片</span>
        <c:import url="content_menubar.jsp">
            <c:param name="et" value="Picture"/>
            <c:param name="etn" value="图片"/>
    ...
    <div class="layui-card-body">
        <form:form action="${ save }" method="post" modelAttribute="picture" cssClass="layui-form">

            <!-- 防止表单重复提交 -->
            <jfp:token/>
            <form:hidden path="id" value="${ picture.id }"/>
            <form:hidden path="pictureData.pictureId" value="${ picture.id }"/>
            <!-- 管理员添加 -->
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:select path="pictureData.copyFromId">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">图片作者</label>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">图片摘要</label>
                    ...
                    <div class="layui-upload">
                        ...
                        <div class="layui-upload-list">
                            <table lay-filter="picTab" lay-size="sm" class="layui-table">
                                ...
                                <tbody id="itemList">
                                <c:if test="${ picture.id != null }">
                                    <c:forEach items="${ picture.pictureData.pictureItems }" var="item">
                                        <tr>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block layui-upload">
                    ...
                    <div class="layui-upload-list">
                        ...
                        <c:if test="${ empty picture.thumb }">
                             src="${ base }assets/css/img/upload_bk.png">
                        </c:if>
                        <c:if test="${ !empty picture.thumb }">
                            src="${ host }/${ picture.thumb }">
                        </c:if>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:checkbox path="pictureData.allowComment" title="允许"/>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input path="pictureData.readPoint" autocomplete="off" lay-verify="number"
                                class="layui-input"/>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <form:checkboxes items="${ memberGroups }"
                                     path="pictureData.groupIds" itemLabel="name" itemValue="id"/>
                </div>
            </div>
    ...
    layui.config({
            ...
            , choose: function (obj) {
                ...
                obj.preview(function (index, file, result) {
                    var tr = $(['<tr id="upload-' + index + '">'
                        ...
                        , '<td><input type="text" name="itemDesc" class="desc-box" placeholder="请输入图片描述">'
        ...
        form.verify({
            title: function (value, item) {
                ...
                $.post("${ base }content/Picture/check", {'time': new Date(), 'ttl': value}, function (data) {
