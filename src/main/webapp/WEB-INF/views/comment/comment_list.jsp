...
<div class="layui-card">
    ...
    <div class="layui-card-body">
        <form id="searchForm" action="${ base }comment/Comment/list" method="get" class="layui-form">
        ...
        <div class="layui-btn-group music-oper">
            <button class="layui-btn layui-btn-danger" data-type="delete">删除选中评论</button>
        </div>
            ...
            <table lay-filter="items" lay-even class="layui-table" lay-size="sm">
                ...
                <c:forEach items="${ page.list }" var="comment">
                    <tr>
                        ...
                        <td>${ comment.id }</td>
                        <td>${ comment.commentData.userName }</td>
                        <td>
                            <span>
                                于<fmt:formatDate value="${ comment.updateTime }" pattern="yyyy-MM-dd HH:mm:ss"/>发表
                            </span>
                                ${ comment.commentData.content }
                        </td>
                        <td>${ comment.title }</td>
                        <td>
                            <a href="${ base }comment/Comment/delete?id=${ comment.id }" name="delete"
...
<script>
    layui.use(['layer', 'laypage', 'laydate', 'form', 'element'], function () {
        ...
        $(".music-oper .layui-btn").on("click", function () {
            var action = "${ base }comment/Comment/batch-" + $(this).data('type');
