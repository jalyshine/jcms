...
<div class="layui-card">
	<div class="layui-card-header">
        <span class="card-title">类别管理</span>
	...
	<div class="layui-card-body">
		<table class="layui-table" lay-size="sm" lay-even>
			...
			<tbody>
			<c:forEach items="${ musicAttributes }" var="attr">
				<tr>
					<td>${ attr.id }</td>
					<td>${ attr.attrName }</td>
					<td>${ attr.attrValue }</td>
					<td>
						<a href="${ base }music/MusicAttribute/edit?name=${ attr.attrName }&id=${ attr.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }music/MusicAttribute/delete?name=${ attr.attrName }&id=${ attr.id }" name="delete"
