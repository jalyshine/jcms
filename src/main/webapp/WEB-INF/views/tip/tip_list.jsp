...
<div class="layui-card">
	<div class="layui-card-header">
		<span class="card-title">贴士</span>
		<c:import url="../menubar.jsp?module=tip" />
	</div>
	<div class="layui-card-body">
		<form action="${ base }tip/Tip/list" method="get" class="layui-form" id="searchForm">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="tid">
							...
							<c:forEach items="${ tipTypes }" var="tt">
		...
		<table lay-filter="items" lay-even class="layui-table" lay-size="sm">
			...
			<tbody>
			<c:forEach items="${ page.list }" var="tip">
				<tr>
					<td>${ tip.id }</td>
					<td>${ tip.title }</td>
					<td>${ tip.description }</td>
					<td>${ tip.tipType.name }</td>
					<td>
						<a href="${ base }tip/Tip/edit?id=${ tip.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }tip/Tip/delete?id=${ tip.id }" name="delete"
