...
<div class="layui-card">
	<div class="layui-card-header">
        <span class="card-title">影片属性</span>
	...
	<div class="layui-card-body">
		<table class="layui-table" lay-size="sm" lay-even>
			...
			<tbody>
			<c:forEach items="${ movieAttributes }" var="attr">
				<tr>
					<td style="text-align: center;">${ attr.id }</td>
					<td>${ attr.attrName }</td>
					<td>${ attr.attrValue }</td>
					<td>
						<a href="${ base }movie/MovieAttribute/edit?name=${ attr.attrName }&id=${ attr.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }movie/MovieAttribute/delete?name=${ attr.attrName }&id=${ attr.id }" name="delete"
