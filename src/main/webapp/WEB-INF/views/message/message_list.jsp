...
<div class="layui-card">
	<div class="layui-card-header">
		<span class="card-title">短消息</span>
		<c:import url="../menubar.jsp?module=message" />
	</div>
	<div class="layui-card-body">
		<form action="${ base }message/Message/list" method="get" class="layui-form" id="searchForm">
		...
		<table lay-filter="items" lay-even class="layui-table" lay-size="sm">
			...
			<c:forEach items="${ page.list }" var="message">
				<tr>
					...
					<td>
						<fmt:formatDate value="${ message.updateTime }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</td>
					<td>
						<a href="${ base }message/Message/edit?id=${ message.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }message/Message/delete?id=${ message.id }" name="delete"
