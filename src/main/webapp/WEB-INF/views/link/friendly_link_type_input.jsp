...
<body>
<c:if test="${ friendlyLinkType.id == null }">
	<c:set value="${ base }link/FriendlyLinkType/add" var="save"/>
</c:if>
<c:if test="${ friendlyLinkType.id != null }">
	<c:set value="${ base }link/FriendlyLinkType/edit" var="save"/>
</c:if>
<div class="layui-card">
	<div class="layui-card-header">
		<span class="card-title">添加 & 编辑链接分类</span>
		<c:import url="../menubar.jsp?module=link" />
	</div>
	<div class="layui-card-body">
		<form:form action="${ save }" method="post" modelAttribute="friendlyLinkType" cssClass="layui-form">
			<!-- 防止表单重复提交 -->
			<jfp:token />
			<form:hidden path="id"/>
