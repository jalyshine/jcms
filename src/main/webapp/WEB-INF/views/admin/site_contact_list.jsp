...
<div class="layui-card">
	...
	<div class="layui-card-body">
		<form action="${ base }admin/SiteContact/list" method="get" class="layui-form" id="searchForm">
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 100px;">
						...
						<input type="hidden" name="odr" value="time desc">
		...
		<table lay-filter="items" lay-even class="layui-table" lay-size="sm">
			...
			<tbody>
			<c:forEach items="${ page.list }" var="siteContact">
				<tr>
					<td>${ siteContact.id }</td>
					<td>${ siteContact.name }</td>
					<td>${ siteContact.phone }</td>
					<td>${ siteContact.email }</td>
					<td>${ siteContact.content }</td>
					<td>
						<fmt:formatDate value="${ siteContact.time }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</td>
					<td>
						<a href="${ base }admin/SiteContact/edit?id=${ siteContact.id }"
						   class="layui-btn layui-btn-xs">编辑</a>
						<a href="${ base }admin/SiteContact/delete?id=${ siteContact.id }" name="delete"
